...
CLANG_CONFIG_ppc_HOST_COMBO_EXTRA_ASFLAGS := $(CLANG_CONFIG_ppc_LINUX_HOST_EXTRA_ASFLAGS)
CLANG_CONFIG_ppc_HOST_COMBO_EXTRA_CFLAGS := $(CLANG_CONFIG_ppc_LINUX_HOST_EXTRA_CFLAGS)
CLANG_CONFIG_ppc_HOST_COMBO_EXTRA_CPPFLAGS := $(CLANG_CONFIG_ppc_LINUX_HOST_EXTRA_CPPFLAGS)
CLANG_CONFIG_ppc_HOST_COMBO_EXTRA_LDFLAGS := $(CLANG_CONFIG_ppc_LINUX_HOST_EXTRA_LDFLAGS)
endif
ifeq ($(HOST_OS),darwin)
CLANG_CONFIG_ppc_HOST_TRIPLE := powerpc-apple-darwin
CLANG_CONFIG_ppc_HOST_COMBO_EXTRA_ASFLAGS := $(CLANG_CONFIG_ppc_DARWIN_HOST_EXTRA_ASFLAGS)
CLANG_CONFIG_ppc_HOST_COMBO_EXTRA_CFLAGS := $(CLANG_CONFIG_ppc_DARWIN_HOST_EXTRA_CFLAGS)
CLANG_CONFIG_ppc_HOST_COMBO_EXTRA_CPPFLAGS := $(CLANG_CONFIG_ppc_DARWIN_HOST_EXTRA_CPPFLAGS)
CLANG_CONFIG_ppc_HOST_COMBO_EXTRA_LDFLAGS := $(CLANG_CONFIG_ppc_DARWIN_HOST_EXTRA_LDFLAGS)
endif
